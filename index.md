...
[![R-CMD-check](https://github.com/charlescoverdale/inflateR/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/charlescoverdale/inflateR/actions/workflows/R-CMD-check.yaml)
[![CRAN
...
worth in the past. Supports GBP, AUD, USD, EUR, CAD, JPY, CNY, CHF, NZD,
INR, KRW, BRL, and NOK.
...
All four functions accept the same currency codes and country names and
are exact inverses within each pair.
...
inflation adjustment, CPI, consumer price index, purchasing power, real
prices, nominal to real, price deflator, international inflation,
currency adjustment, R package
